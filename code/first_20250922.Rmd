...
This tells R puts whatever is one the left of the *pipe* into the first place in the command to the right of the \em{pipe}. The c
ommand for generating the chart is **ggplot**.
