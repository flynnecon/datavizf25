...
We block of code with the 3 single quotes and then use braces around **r** so it knows what we are using that program at the start and after the commands close it with 3 single quotes.

```{r}
library(tidyverse)
urlfile="https://raw.githubusercontent.com/flynnecon/datavizf25/refs/heads/main/online_monthly_R.csv"
```
